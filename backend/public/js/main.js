...
(function ($) {
  ...
  $(function () {
    ...
    $todoPanel.on('submit', 'form', function (e) {
      e.preventDefault();
      var $t = $(this),
          $input = $t.find('.form-control');
      $('<li class="list-group-item" style="display: none;"><label class="todo--label"><input type="checkbox" name="" value="1" class="todo--input"><span class="todo--text">' + $input.val() + '</span></label><a href="#" class="todo--remove">&times;</a></li>').appendTo($t.children('.list-group')).slideDown('slow');
      $input.val('');
