    ...
    <section class="main--content">
        ...
        <panel>
            <div class="records--body">
                ...
                <form @submit.prevent="createRelatedLink">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-9 offset-md-3">
                            ...
                            <input type="submit" value="Tambah Link Terkait" class="btn btn-rounded btn-success">
                        </div>
                    </div>
                </form>
            </div>
...
export default {
    ...
    setup() {
        ...
        const createRelatedLink = async () => {
            let formData = {
                title:  title.value,
                link: link.value
            }
            axios.post(window.location.origin + '/api/admin/related-link/create', formData).then(response => {
                swal({
                    icon: 'success',
                    title: 'Berhasil!',
                    text: response.data,
